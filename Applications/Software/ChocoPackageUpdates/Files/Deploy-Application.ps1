...
Try {
	...
	[string]$appScriptDate = '09/07/2019'
	[string]$appScriptAuthor = 'Jack Rudlin'
	##*===============================================
	## Variables: Install Titles (Only set here to override defaults set by the toolkit)
	[string]$installName = 'Monthly Application Patching'
	[string]$installTitle = 'Monthly Application Patching'
